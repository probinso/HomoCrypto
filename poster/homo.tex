...
\begin{align*}
  c_i\cdot c_j &= \left(p\cdot q_i + n_i + b_i\right)\\&\;\cdot\left(p\cdot q_j + n_j + b_j\right)\\
  &= p\cdot\hat{q} + \hat{n} + \left(b_i\cdot b_j\right)
\end{align*}
\columnbreak
...
\begin{align*}
  c_i+ c_j &= \left(p\cdot q_i + n_i + b_i\right)\\&\;+\left(p\cdot q_j + n_j + b_j\right)\\
  &= p\cdot(q_i+q_j)+(n_i+n_j) \\&\;+ b_i + b_j\\
  &= p\cdot\hat{q} + \hat{n} +\left(b_i+b_j\right)
\end{align*}
