...
% no additional work. 
% 
% Also we should talk about what some of these variables 
% mean for human readability. like alpha/beta s relation
% to the usbset sum problem, and what a nist equivelent 
% security parameter would be. We can pull more from the 
% poster, as this and the poster are to be seperate.
%
% We may want to use listings to actually place our code
% into each of these sections that are relivent. 
% ---- End Philip ------
